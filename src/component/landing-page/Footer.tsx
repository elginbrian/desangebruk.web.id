      ...
      <div className="max-w-7xl mx-auto px-4 mb-6 sm:px-6 lg:px-8">
        <div className={`flex flex-col md:flex-row justify-between items-center md:items-center mb-6 md:mb-4 smooth-transition ${mounted ? "smooth-reveal stagger-1" : "animate-on-load"}`}>
          ...
          <div className="flex flex-row justify-center md:justify-start gap-2 sm:gap-3 w-full md:w-auto">
            <a
              href="https://www.instagram.com/ngebruk.sumberpucung?igsh=ZHI0dWg2MG8yb3Zq"
            ...
            <a href="https://www.youtube.com/@DesaNgebrugSumberpucung" className="flex items-center justify-center px-2 py-2  border border-white/30 rounded-lg hover:bg-white/10 smooth-transition text-xs md:text-sm hover-lift">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-2 md:space-y-1">
              <div className="flex items-center justify-center md:justify-start hover-lift smooth-transition">
                ...
                <span className="text-white/90 text-sm md:text-sm">082139277699</span>
              </div>
              <div className="flex items-center justify-center md:justify-start hover-lift smooth-transition">
                <FiMail size={16} className="mr-3 text-white/80 flex-shrink-0" />
                <span className="text-white/90 text-sm md:text-sm break-all">it.mmd.filkom49@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={`bg-[#152d55] py-4 md:py-3 smooth-transition ${mounted ? "smooth-reveal stagger-4" : "animate-on-load"}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-3">
            ...
            />
            <div className="text-center md:text-left">
              <p className="text-white text-[10px] md:text-[10px] mb-[2px] smooth-transition">Dikembangkan oleh Tim MMD FILKOM 49 Tahun 2025</p>
              <p className="text-white/70 text-[10px] md:text-[10px] leading-relaxed smooth-transition">Program Mahasiswa Membangun Desa, Fakultas Ilmu Komputer, Universitas Brawijaya</p>
            </div>
          </div>
        </div>
      </div>

    ...
    <>
      ...
      <header className="bg-white app-header border-b border-gray-200">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="app-text-2xl font-bold text-black">Kelola Pengumuman</h1>
            <p className="text-gray-600 text-xs mt-1">Kelola dan atur pengumuman desa</p>
          </div>
        ...
        <div className="bg-white app-card shadow-sm border border-gray-100">
          ...
          <div className="pb-4 border-b border-gray-100">
            <div className="flex justify-between items-center gap-4">
              <h3 className="app-text-lg font-semibold text-black">Pengumuman</h3>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredAnnouncements.map((announcement) => (
                  <tr key={announcement.id} className="hover:bg-gray-50">
                    <td className="app-table-cell whitespace-nowrap text-xs font-medium text-black">{announcement.title}</td>
                    <td className="app-table-cell whitespace-nowrap text-xs text-gray-600">{announcement.dateCreated}</td>
                    <td className="app-table-cell whitespace-nowrap">
                      <span className="app-button-small bg-orange-100 text-orange-800 font-medium">{announcement.status}</span>
                    </td>
